    ...
    <div class="container">
        <section class="grid  grid-rows-2 md:grid-rows-none md:grid-cols-2 gap-2 pt-7 md:pt-14">
            <div class="flex flex-col my-auto gap-2">
                <h1
                    class="text-foreground text-center md:text-left text-3xl font-bold leading-tight tracking-tighter md:text-6xl lg:leading-[1.1] origin-center">
                    Having hard time deploying your project ?
                </h1>
            ...
            <div class="m-auto">
                ...
                }" src="@/assets/img/white-bg.png" class="dark:hidden inline-block" alt="Light Mode Image">
                <img v-motion :initial="{
                    x: -400, y: -400, opacity: 0, scale: 0.4
                }" :enter="{
                    x: 0, y: 0, opacity: 1, scale: 1, transition: {
                ...
                }" src="@/assets/img/black-bg.png" class="hidden dark:inline-block" alt="Dark Mode Image">
            </div>
        </section>
            ...
            <div>
                <Carousel class="relative w-full max-w-2xl justify-center items-center" :plugins="[Autoplay({
                    ...
                    <CarouselContent class="-ml-2">
                        <CarouselItem v-for="(imag, index) in logoIcons" :key="index"
                            class="pl-2 basis-1/4 md:basis-16">
                            <div class="p-1">
                                <Card>
